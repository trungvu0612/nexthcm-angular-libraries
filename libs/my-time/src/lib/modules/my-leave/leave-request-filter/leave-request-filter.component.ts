...
import { RequestListFilterComponent } from '../../shared/request-list-filter/request-list-filter.component';

@Component({
  selector: 'hcm-leave-request-filter',
...
@NgModule({
  ...
  exports: [LeaveRequestFilterComponent],
})
export class LeaveRequestFilterComponentModule {}
