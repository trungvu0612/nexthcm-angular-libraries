...
@Component({
  selector: 'hcm-working-outside',
  templateUrl: './working-outside.component.html',
  styleUrls: ['./working-outside.component.scss'],
  providers: [TuiDestroyService],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WorkingOutsideComponent implements OnInit {
  today: Date = new Date();
  requests: Requests[] = [];
