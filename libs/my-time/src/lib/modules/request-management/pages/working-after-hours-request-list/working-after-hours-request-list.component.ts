  ...
  implements ServerPaginationTableComponent<WorkingAfterHoursRequest>
{
  ...
  private readonly request$ = this.queryParams$.pipe(
    switchMap(() =>
      this.myTimeService.getRequests<WorkingAfterHoursRequest>(RequestTypesUrlPath.afterHours, this.queryParams$.value)
    )
  );
  ...
  private updateRequest(id: string, payload: UpdateRequestPayload): Observable<unknown> {
    return this.myTimeService
      .updateRequest(RequestTypesUrlPath.afterHours, id, payload)
