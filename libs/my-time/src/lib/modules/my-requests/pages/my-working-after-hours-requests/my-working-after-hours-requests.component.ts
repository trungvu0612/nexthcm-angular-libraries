...
export class MyWorkingAfterHoursRequestsComponent extends AbstractMyRequestListComponent<WorkingAfterHoursRequest> {
  ...
  constructor(
    ...
    override readonly state: RxState<Pagination<WorkingAfterHoursRequest>>,
