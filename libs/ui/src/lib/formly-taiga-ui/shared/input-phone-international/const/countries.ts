import { Country, TuiCountryIsoCode } from '@taiga-ui/kit';
...
export const COUNTRIES: Record<string, Country> = {
  ...
  [TuiCountryIsoCode.ID]: { mask: '+62(###) ###-##-###', name: 'Indonesia ' },
  ...
  [TuiCountryIsoCode.MY]: { mask: '+60(###) ###-###', name: 'Malaysia' },
  ...
  [TuiCountryIsoCode.NG]: { mask: '+234(###) ###-####', name: 'Nigeria' },
  ...
  [TuiCountryIsoCode.TH]: { mask: '+66##-###-####', name: 'Thailand' },
  ...
  [TuiCountryIsoCode.VN]: { mask: '+84(###) ####-###', name: 'Vietnam' },
