...
export class UpsertLeaveEntitlementDialogComponent implements OnInit {
  ...
  form = this.fb.group({} as LeaveEntitlement);
  ...
  fields: FormlyFieldConfig[] = [
    ...
    },
    {
      ...
      templateOptions: {
        labelClassName: 'font-semibold',
        translate: true,
        label: `${this.translocoScope.scope}.multipleEmployees`,
      },
    },
    {
      key: 'employeeDTO',
    ...
    },
    {
      ...
      templateOptions: {
        ...
        translate: true,
        labelClassName: 'font-semibold',
        label: `${this.translocoScope.scope}.entitlementDays`,
        ...
        tap(
          this.promptService.handleResponse(
            `${this.translocoScope.scope}.${
              payload.id ? 'editLeaveEntitlementSuccessfully' : 'createLeaveEntitlementSuccessfully'
            }`,
