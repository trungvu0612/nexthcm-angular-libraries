...
@Component({
  selector: 'hcm-edit-leave-level-approve',
  templateUrl: './edit-leave-level-approve.component.html',
  styleUrls: ['./edit-leave-level-approve.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class EditLeaveLevelApproveComponent implements OnInit {
