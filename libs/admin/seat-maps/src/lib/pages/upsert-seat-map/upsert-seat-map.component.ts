...
export class UpsertSeatMapComponent implements AfterViewInit {
          ...
          fieldGroup: [
            {
              ...
              templateOptions: {
                translate: true,
                label: `${this.translocoScope.scope}.width`,
                min: 10,
                max: 333,
                labelClassName: 'font-semibold',
              },
            },
            {
              ...
              templateOptions: {
                translate: true,
                label: `${this.translocoScope.scope}.height`,
                min: 10,
                max: 333,
                labelClassName: 'font-semibold',
              },
            },
            {
              ...
              templateOptions: {
                translate: true,
                label: `${this.translocoScope.scope}.rounded`,
                max: 50,
                labelClassName: 'font-semibold',
              },
            },
  ...
  seatForm = this.fb.group(this.seatModel);
