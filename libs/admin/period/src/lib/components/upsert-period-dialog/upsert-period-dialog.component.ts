...
@Component({
  selector: 'hcm-upsert-period-dialog',
  templateUrl: './upsert-period-dialog.component.html',
  styleUrls: ['./upsert-period-dialog.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UpsertPeriodDialogComponent implements OnInit {
