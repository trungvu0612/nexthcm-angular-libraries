...
import {
  loadNotificationEmailVariables,
...
export class UpsertNotificationComponent {
  ...
  fields: FormlyFieldConfig[] = [
        ...
        },
        {
          ...
          templateOptions: {
            ...
            options: this.translocoService
              .selectTranslateObject<HashMap<string>>('NOTIFICATION_TYPES', {}, this.translocoScope.scope)
              .pipe(
                map(
                  (result) =>
                    [
    ...
    },
    {
      ...
      templateOptions: {
        ...
        variables: this.notificationEmailVariablesQuery.selectAll(),
      },
    },
    { key: 'content' },
    { key: 'notifyId' },
  ...
  constructor(
    ...
    private readonly notificationEmailVariablesQuery: NotificationEmailVariablesQuery,
    actions: Actions
  ) {
    state.hold(this.submitPrompt$);
    actions.dispatch(loadRoles());
    actions.dispatch(loadNotificationEmailVariables());
  }
